...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 1. INJECT FIXED TOP-LEFT HEADER (No bottom border line)
    if (headerWrapper) {
    ...
    // 2. INJECT FIXED BOTTOM NAVIGATION FOOTER
    if (navWrapper) {
        navWrapper.innerHTML = `
            ...
            <nav class="nav-container">
                <a href="/index.html" target="_self" class="nav-item" id="nav-home">
                    <img src="https://img.icons8.com/?size=100&id=2797&format=png" alt="Home">
                    <span>Home</span>
                </a>
                <a href="/hustler.html" target="_self" class="nav-item" id="nav-hustler">
                    <img src="https://cdn-icons-png.flaticon.com/128/1420/1420462.png" alt="Hustler">
                    <span>Hustler</span>
                </a>
                <a href="/explore.html" target="_self" class="nav-item" id="nav-explore">
                    <img src="https://cdn-icons-png.flaticon.com/128/253/253318.png" alt="Explore">
                    <span>Explore</span>
                </a>
                <a href="/creator.html" target="_self" class="nav-item" id="nav-creator">
                    <img src="https://cdn-icons-png.flaticon.com/128/11279/11279839.png" alt="Creator">
                    <span>Creator</span>
                </a>
                <a href="/menu.html" target="_self" class="nav-item" id="nav-menu">
        ...
        // 3. APPLY DETERMINISTIC HIGHLIGHTING
